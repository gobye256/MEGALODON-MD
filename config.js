...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~QBgB1QLb#k-p1OgyqzuBj8wHRCT9pZDXxY_03g0SX7DapXW94-hk",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "256759694671",  // Owner's WhatsApp number
    
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "ADD YOUR NAME",           // Owner's name
    
    DEV: process.env.DEV || "256759694671",                     // Developer's contact number
